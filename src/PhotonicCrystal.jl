...
"""
function SimulationDefinition.Simulation(dom::Domain; bnd::Boundary=Boundary(bc=PeriodicBC), dis::Discretization, sct::Scattering=Scattering(), tls::TwoLevelSystem=TwoLevelSystem(), Na::Int=1, Nb::Int=1)
    lattice = dom.lattice
...
"""
SimulationDefinition.Simulation(dom::Domain, sim::Simulation; Na::Int=1, Nb::Int=1) = Simulation(dom; dis=sim.dis, tls=sim.tls, Na=Na, Nb=Nb)
"""
