...
HelmholtzEigenBase.eig_knl(sim::Simulation, k; kwargs...) = eig_knl(sim.sys.ε, sim.dis.N, sim.bnd.∂Ω, sim.dis.dx, sim.dis.coordinate_system, sim.bnd.bc, sim.bnd.bl, k; kwargs...)
